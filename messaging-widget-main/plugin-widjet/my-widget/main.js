...
let apexInit = {
  ...
  baseLineChart: () => {
    ...
    let basicLineChart = apexInit.init(chartOptions);
    basicLineChart.render();
  },
  "container": document.querySelector("#chart"),
  'init': (args) => {
    let container = args.container || apexInit.container;
    let options = apexInit.checkChartOptions(args);
